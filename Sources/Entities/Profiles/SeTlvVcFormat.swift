...
public struct SeTlvVcFormat: FormatProfile {
  
  static let FORMAT = "vc+se-tlv"
...
public extension SeTlvVcFormat {
  
  struct SeTlvVcSingleCredential: Codable {
    public let proof: Proof?
    public let format: String = SeTlvVcFormat.FORMAT
  ...
  struct SeTlvVcClaimSet: Codable {
  ...
  struct CredentialConfigurationDTO: Codable {
    ...
    func toDomain() throws -> SeTlvVcFormat.CredentialConfiguration {
