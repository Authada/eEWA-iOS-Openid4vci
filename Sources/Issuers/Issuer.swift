...
public actor Issuer: IssuerType {
  ...
  public func pushAuthorizationCodeRequest(
    credentialOffer: CredentialOffer,
    clientAssertion: ClientAssertion? = nil,
    claims: ClaimSet? = nil
  ) async throws -> Result<UnauthorizedRequest, Error> {
  ...
  public func requestAccessToken(authorizationCode: UnauthorizedRequest, clientAssertion: ClientAssertion? = nil) async -> Result<AuthorizedRequest, Error> {
    switch authorizationCode {
    case .par:
